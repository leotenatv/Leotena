    ...
    fun eaMaxOkoaQualityApiScript(): String {
        return """
            (function() {
              ...
              window.__eaMaxOkoaApplyStartupDefault = function() {
                ...
                if (window.__eaMaxStartupDefaultActive) return false;
                window.__eaMaxStartupDefaultActive = true;
                var tries = 0;
                function attempt() {
                  if (window.__eaMaxOkoaUserInitiated) {
                    window.__eaMaxStartupDefaultActive = false;
                    return;
                  }
              ...
              // Back-compat alias used by older inject paths.
              window.__eaMaxOkoaApplyStartup360 = window.__eaMaxOkoaApplyStartupDefault;
              window.__eaMaxOkoaSetQuality = function(mode, userInitiated) {
                userInitiated = !!userInitiated;
                if (!userInitiated) {
                  if (window.__eaMaxUserQualityLocked) return true;
                  window.__eaMaxOkoaLastMode = String(mode || '480');
                  return window.__eaMaxOkoaApplyStartupDefault();
                }
