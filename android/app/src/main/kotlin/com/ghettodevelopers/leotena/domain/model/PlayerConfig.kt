package com.ghettodevelopers.leotena.domain.model
...
data class PlayerConfig(
    val selectedQuality: StreamQuality = StreamQuality.QUALITY_480P,
    val selectedAudioLanguage: String = "sw",
    val isABREnabled: Boolean = false,
