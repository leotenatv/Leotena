...
import com.ghettodevelopers.leotena.domain.model.ClearKey
...
object StreamSessionBuilder {
    ...
    fun fromFlutterBundle(b: Bundle): StreamSession {
        ...
        return StreamSession(
            ...
            token = token,
            expiresAt = expiresAt,
            playerMode = if (StreamUrlClassifier.shouldUseWebViewForUrl(url)) PlayerMode.WEB else PlayerMode.EXO,
            drmType = drmType,
            drmData = drmData,
